...
app.get('/api/hello/:id', async (req, res) => {
  ...
  const data = [
    { id: 1, name: "https://localhost:8080/api/hello/1", url_part: "company-website", parentId: null, textInput: "Do you have an Aruba Kubernetes cluster for your project?",
    decisions: [
            { decision: "Yes", children_id: 2 },
            { decision: "No", children_id: 5 }
        ]
    },
    { id: 2, name: "https://localhost:8080/api/hello/2", url_part: "company-website/cluster-yes", parentId: 1, textInput: "Do you have a domain name?",
    decisions: [
    ...
    { id: 6, name: "https://localhost:8080/api/hello/6", url_part: "company-website/cluster-no/another-provider-yes", parentId: 2, textInput: "Would you like to compute which is more beneficial?", decisions: [] },
    { id: 7, name: "https://localhost:8080/api/hello/7", url_part: "company-website/cluster-no/another-provider-no", parentId: 2, textInput: "", decisions: [] },
    { id: 8, name: "https://localhost:8080/api/hello/8", url_part: "wordpress-shop", parentId: null, textInput: "", decisions: [] },
    { id: 9, name: "https://localhost:8080/api/hello/9", url_part: "kubernetes-education", parentId: null, textInput: "", decisions: [] },
    { id: 10, name: "https://localhost:8080/api/hello/10", url_part: "marketing", parentId: null, textInput: "", decisions: [] },
    { id: 11, name: "https://localhost:8080/api/hello/11", url_part: "cost-optimization", parentId: null, textInput: "", decisions: [] },
    { id: 12, name: "https://localhost:8080/api/hello/12", url_part: "publish-application", parentId: null, textInput: "", decisions: [] },
    { id: 13, name: "https://localhost:8080/api/hello/13", url_part: "organize-hackathon", parentId: null, textInput: "", decisions: [] }
  ];
